...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.login = function (username, password) {
        return __awaiter(this, void 0, void 0, function () {
            var stmt, user, isValid, updateStmt, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!user.is_active) {
                            return [2 /*return*/, { success: false, error: 'Account is deactivated' }];
                        }
    ...
    AuthService.prototype.changePassword = function (userId, oldPassword, newPassword) {
        return __awaiter(this, void 0, void 0, function () {
            var stmt, user, isValid, newHash, updateStmt, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        ...
                        return [4 /*yield*/, bcrypt.compare(oldPassword, user.password_hash)];
                    case 1:
                        isValid = _a.sent();
                        if (!isValid) {

...
class BankReconciliationService {
    ...
    importTransaction(transaction) {
        ...
        VALUES (?, ?, ?, ?)
      `);
            const result = stmt.run(transaction.transactionDate, transaction.amount, transaction.description || null, transaction.reference || null);
            return {
                success: true,
    ...
    matchTransaction(transactionId, promissoryNoteId, userId) {
        try {
            const stmt = this.db.prepare(`
